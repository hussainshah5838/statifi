...
import 'package:statifi/app/module/community/controller/strategy_share_controller.dart';
...
class StrategyShareScreen extends StatelessWidget {
  const StrategyShareScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(StrategyShareController());
    return Scaffold(
      body: SafeArea(
        child: Container(
          ...
          child: Column(
            ...
            children: [
              AppbarHeader(title: "Strategy Share"),

              const SizedBox(height: 20),

              Text("Title", style: AppTextStyles.body),
              const SizedBox(height: 10),
              CustomTextField(hintText: "enter your strategy share title..."),
              ...
              const SizedBox(height: 10),
              CustomTextField(
                hintText: "Share your strategy share in detail...",
                maxLine: 4,
              ),
