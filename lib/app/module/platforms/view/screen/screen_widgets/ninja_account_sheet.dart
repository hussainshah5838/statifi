...
class NinjaAccountSheet extends StatelessWidget {
  const NinjaAccountSheet({super.key});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          CustomTextField(hintText: 'custom ninjatrader path'),
