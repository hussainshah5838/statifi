...
class TradovateAccountSheet extends StatelessWidget {
  const TradovateAccountSheet({super.key});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          CustomTextField(hintText: 'App id'),

          const SizedBox(height: 15),

          CustomTextField(hintText: 'customer ID'),
          ...
          CustomTextField(hintText: 'email address or ID'),
